...
<h1>Modificar Usuarios</h1>
	...
	<form action="UsuarioServlet" method="post">
		...
		<p><label>Nombres: </label></p><input type="text" name="nombres" id="idnombres">
		<p><label>ApPaterno: </label></p><input type="text" name="appaterno" id="idappaterno">
		<p><label>ApMaterno: </label></p><input type="text" name="apmaterno" id="idapmaterno">
